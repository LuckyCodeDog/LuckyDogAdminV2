...
namespace LuckyDog.Admin.Repository.SugarHandler
{
    ...
    public class SugarRepository<TEntity> : ISugarRepository<TEntity> where TEntity : class, new()
    {
        ...
        {
            return await _sqlSugarClient.Insertable(entitys.ToArray()).ExecuteCommandAsync();
        }
        ...
        {
            var result = await _sqlSugarClient.Insertable(keyValues).ExecuteCommandAsync();
            return result;
        }
        ...
        {
            var result = await _sqlSugarClient.Insertable(entity).ExecuteReturnEntityAsync();
            return result;
        }
        ...
        {
            var result = await _sqlSugarClient.Insertable(entity).ExecuteCommandAsync() > 0;
            return result;
        }
        ...
        {
            var result = await _sqlSugarClient.Insertable(entitys).ExecuteCommandAsync() > 0;
            return result;
        }
        ...
        public async Task<int> UpdateAsync(List<TEntity> entitys, List<string>? lstIgnoreColumns = null,
            bool isLock = true)
        {
            IUpdateable<TEntity> up = _sqlSugarClient.Updateable(entitys);
            if (lstIgnoreColumns != null && lstIgnoreColumns.Count > 0)
            {
                up = up.IgnoreColumns(lstIgnoreColumns.ToArray());
            }
        ...
        {
            IUpdateable<TEntity> up = _sqlSugarClient.Updateable<TEntity>().SetColumns(update);
            if (where != null)
            {
                up = up.Where(where);
            }
        ...
        public async Task<int> UpdateAsync(Dictionary<string, object> keyValues,
            Expression<Func<TEntity, bool>> where = null, bool isLock = true)
        {
            IUpdateable<TEntity> up = _sqlSugarClient.Updateable<TEntity>(keyValues);
            if (where != null)
            {
                up = up.Where(where);
            }
        ...
        public async Task<int> UpdateColumnsAsync(List<TEntity> entitys,
            ...
            bool isLock = true)
        {
            IUpdateable<TEntity> up = _sqlSugarClient.Updateable(entitys).UpdateColumns(updateColumns);
            ...
            Dictionary<string, object> where, bool isLock = true)
        {
            ...
            IUpdateable<TEntity> up = _sqlSugarClient.Updateable<TEntity>().SetColumns(update).Where(sqlWhere);
            if (isLock)
            {
                up = up.With(SqlWith.UpdLock);
            }
        ...
        public async Task<bool> DeleteByPrimaryAsync(object id, bool isLock = true)
        {
            ...
            var del = _sqlSugarClient.Deleteable<TEntity>(id);
            if (isLock)
            {
        ...
        {
            var del = _sqlSugarClient.Deleteable<TEntity>().In(primaryKeyValues);
            if (isLock)
            {
                del = del.With(SqlWith.RowLock);
            }
        ...
        {
            var del = _sqlSugarClient.Deleteable(entity);
            if (isLock)
            {
                del = del.With(SqlWith.RowLock);
            }
        ...
        {
            var del = _sqlSugarClient.Deleteable(entitys);
            if (isLock)
            {
                del = del.With(SqlWith.RowLock);
            }
        ...
        {
            var del = _sqlSugarClient.Deleteable<TEntity>().Where(whereLambda);
            if (isLock)
            {
                del = del.With(SqlWith.RowLock);
            }
        ...
        {
            var del = _sqlSugarClient.Deleteable<TEntity>().In(inValues);
            if (isLock)
            {
                del = del.With(SqlWith.RowLock);
            }
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().WhereIF(!whereLambda.IsNullOrEmpty(), whereLambda)
                .Select(expression)
                .FirstAsync();
        }
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().WhereIF(whereLambda.IsNotNull(), whereLambda)
        ...
        {
            return await _sqlSugarClient.SqlQueryable<TEntity>(sql).ToListAsync();
        }
        ...
        /// <returns></returns>
        public async Task<List<TEntity>> QueryPageListAsync<T, T2, T3>(
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().In(inFieldName, inValues).ToListAsync();
        }
            ...
            var conModels = new List<IConditionalModel>
        {
            ...
            return await _sqlSugarClient.Queryable<TEntity>().Where(conModels).SingleAsync();
            // 这种方式不适合软删除模式
            ...
            var conModels = new List<IConditionalModel>
        {
            ...
            return await _sqlSugarClient.Queryable<TEntity>().Where(conModels).ToListAsync();
        ...
        {
            return await _sqlSugarClient.Ado.GetDataTableAsync(sql);
        }
        ...
        {
            return await _sqlSugarClient.Ado.GetScalarAsync(sql);
        }
        ...
        {
            ISugarQueryable<TEntity> up = _sqlSugarClient.Queryable<TEntity>();
            if (whereLambda != null)
            {
        ...
        public async Task<DataSet> QueryProcedureDataSetAsync(string procedureName, List<SugarParameter> parameters)
        {
            ...
            var datas = await _sqlSugarClient.Ado.UseStoredProcedure().GetDataSetAllAsync(procedureName, listParams);
            return datas;
        }
        ...
        {
            var listParams = ConvetParameter(parameters);
            var datas = await _sqlSugarClient.Ado.UseStoredProcedure().GetDataTableAsync(procedureName, listParams);
            return datas;
        }
        ...
        {
            var listParams = ConvetParameter(parameters);
            var datas = await _sqlSugarClient.Ado.UseStoredProcedure().GetScalarAsync(procedureName, listParams);
            return datas;
        }
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().WhereIF(!whereLambda.IsNullOrEmpty(), whereLambda).Take(topNum)
                .ToListAsync();
        }
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().WhereIF(!whereLambda.IsNullOrEmpty(), whereLambda).AnyAsync();
        }
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().SumAsync<int>(field);
        }
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().MaxAsync<TResult>(field);
        }
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().MinAsync<TResult>(field);
        }
        ...
        {
            return await _sqlSugarClient.Queryable<TEntity>().AvgAsync<int>(field);
        }
            ...
            string dateFomart = "")
        {
            ...
            var maxValue = await _sqlSugarClient.Queryable<TEntity>()
